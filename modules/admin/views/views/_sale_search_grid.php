...
<div class="sale-index">
    ...
    <div class="accordion" id="accordionEx" role="tablist" aria-multiselectable="true">
        ...
        <form method="get" id="w0">
            ...
            <div class="card">
                <!-- Card header -->
                <div class="card-header" style="padding-left: 0px;padding-right: 0px;" role="tab" id="headingMain">
                    <a data-toggle="collapse" href="#collapseMain" aria-expanded="true" aria-controls="collapseMain">
                        <h5 class="mb-0">Основные<i class="fa fa-angle-down rotate-icon"></i>
                        </h5>
                    </a>
                </div>
                ...
                <!-- Card header -->
                <div class="card-header" style="padding-left: 0px;padding-right: 0px;" role="tab" id="headingOne">
                ...
                <!-- Card header -->
                <div class="card-header" style="padding-left: 0px;padding-right: 0px;" role="tab"
                     id="headingExtended">
                ...
                <div class="card-header" style="padding-left: 0px;padding-right: 0px;" role="tab" id="headingSave">
