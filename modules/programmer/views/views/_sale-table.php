...
if ($sale) {
    ...
    <div class="container-fluid">
        ...
        <div class="row no-p sim_id_<?php echo $sale->id_similar; ?> m-0 p-0"
             id="row_<?= $sale->id; ?>" <?php if ($sale->similar->moderated == 3) echo "style=\"background-color: #e8f5e9;\""; ?>>

            <div class="col-sm-4 col-md-4 col-4 col-lg-1 m-0 p-0"><?= $sale->renderUrl(); ?>
                <div class="row m-0 p-0" style='min-height: 90px;padding-right: 20px;'>
                    <? echo $sale->photos; ?>
                </div>
                <?php if ($sale->similar->moderated == \app\models\SaleSimilar::MODERATED) echo Renders::MODERATED(); ?>
            </div>
            <div class="col-sm-8 col-8 col-md-8 col-lg-2 m-0 p-0">
            ...
            <div class="col-sm-12 col-12 col-lg-4 col-md-4 p-0 m-0">
                <a data-toggle="collapse" href="#collapseExample<?= $sale->id ?>" aria-expanded="false"
                   aria-controls="collapseExample">Описание </a>   <div class="float-right d-block d-sm-block d-md-none"><?= \app\models\Renders::Price($sale->price); ?></div>

                <div class="collapse" id="collapseExample<?= $sale->id ?>" style="font-size:0.9rem">
            ...
            <div class="col-sm-8 col-8 col-md-6 col-lg-4 p-0 m-0">
                <div class="row p-0 m-0">
                    <div class="col-sm-5 p-0 m-0">
                         <div class="float-right d-none d-lg-block d-xl-block "><?= \app\models\Renders::Price($sale->price); ?></div>
                        <?php
                    ...
                    <div class="col-sm-7 p-0 m-0"><small>
                            <?= $sale->renderContacts(); ?>
                        </small>
            ...
            <div class="col-sm-4 col-4 col-lg-1 col-md-2 p-0 m-0">
