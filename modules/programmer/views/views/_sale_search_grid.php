...
<div class="sale-index">
    <form method="get" id="w0">
        <div class="row" style="height: 50px;">
            <div class="searching_tags_div col-md-10 col-lg-11 col-sm-10 col-10 pr-0 mr-0 "></div>
            <div class="col-md-2 col-lg-1 col-sm-2 col-2">
                <?= Html::submitButton('<i class="fa fa-search" aria-hidden="true"></i>', ['class' => 'btn btn-primary p-2 m-0 btn-sm btn-rounded']) ?>
            </div>
        </div>
        <!--Accordion wrapper-->
        <div class="accordion" id="accordionEx" role="tablist" aria-multiselectable="true">
            ...
            <div class="card">
                ...
                <div id="collapseMain" class="collapse" role="tabpanel" aria-labelledby="headingMain"
                    ...
                    <?php if (Yii::$app->user->can(\app\models\User::ROLE_PLAN2)) { ?>
                    <div class="row no-margin-botton justify-content-center">
                        <div class="col-md-12 col-lg-12 col-sm-12 col-12 no-margin-botton">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-2 col-lg-1 col-sm-2 col-2">
                                    <? //  echo Html::submitButton('<i class="fa fa-refresh" aria-hidden="true"></i>', ['class' => 'btn btn-primary btn-sm btn-rounded']) ?>
                                </div>
                            </div>
                        </div>
                    </div>
