...
<div class="sale-filters-search">
    <form method="get" id="w0">
        <div class="row">
            ...
            <div class="col-sm-4 col-md-3 col-lg-1 col-6">
            ...
            <div class="col-sm-4 col-md-3 col-lg-2 col-6">
                <?php echo Mdb::ActiveSelect($model, 'status', [0 => 'Любой'] + SaleFilters::mapStatuses()); ?>
            </div>


            <div class="col-sm-6 col-md-6 col-lg-2 col-9">
