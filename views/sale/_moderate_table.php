...
<div class="row">
    ...
    <div class="col-sm-1">
        <?= Html::a($sale->id_address, Url::toRoute(['addresses/view', 'id' => $sale->id_address]), ['target' => '_blank']); ?>
    </div>
    <div class="col-sm-2">

        <?= Html::a($sale->id_similar, Url::toRoute(['sale-similar/view', 'id' => $sale->id_similar]), ['target' => '_blank']); ?>
        <?= Html::a($sale->id, Url::toRoute(['sale/view', 'id' => $sale->id]), ['target' => '_blank']); ?>
...
<br>".$sale->similarNew->tags_id."<br>".
            TagsWidgets::widget(['tags' => Methods::convertToArrayWithBorders($sale->similarNew->tags_id), 'moderate' => true])."<br>" ; ?>
