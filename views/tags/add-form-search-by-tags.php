...
$tags_groups = \app\models\Tags::getGroupedTags('address');
$session = Yii::$app->session;
                ...
                <div class="card-body">
                    ...
                    if (count($tags) != 0) {
                        foreach ($tags as $tag) {
                            ...
                            <a href="#" class="tags-action-button-address" id="tag_<?= $tag->id; ?>"  data-address_id=2000000"
