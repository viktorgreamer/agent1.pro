        ...
        foreach ($this->sales as $key => $address) {
          ...
          // если id_address существует тo ставим его координаты
           if ($key !== 0) {
            ...
            $balloonContentBody = $message." ".\Yii::$app->view->render('@app/views/sale/_mini_sale_map', ['sales' => $address, 'contacts' => true, 'salefilter' => $this->salefilter, 'controls' => $this->controls]);
